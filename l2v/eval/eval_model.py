...
from l2v.eval.compute_predictions import get_evaluator
from l2v.eval.evaluation import load_predictions, save_evaluation
from l2v.train.evaluator import ResultKey
from l2v.utils import py_utils
from l2v.utils.py_utils import load_json_object, val_to_str
...
def main():
  ...
  for dataset in [CocoCaptioning("val")]:
    if args.eval_name:
